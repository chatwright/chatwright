...
| [`formats/bot-protocol/v1/`](formats/bot-protocol/v1/README.md) | The bot protocol v1 — remote HTTPS by platform reference, and the iframe postMessage envelope (canonical here; decision 0012) |

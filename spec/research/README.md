...
| [Observation model](observation-model.md) | OM-01–OM-28 | Actor-neutral observation projection: identity/lifecycle, window policy, content/ordering, action staleness/concurrency, and branching/replay/Studio boundaries |
